              ...
              if(isset($_REQUEST["inid"]))
               {
                 ...
                 if(is_numeric($inid))
                 {
                $result = $dbh->prepare("SELECT * from general_information where language_id=3 and publish_id=1 and info_id=:inid");
      ...
      <div class="row">
          ...
          <aside>
            ...
            <div class="widget droid">
              <h4 class="droid" align='right'>تعرف علی عیونك</h4>
...
<?php
                  ...
                  $result = $dbh->prepare("SELECT * from general_information where language_id=3 and publish_id=1");
                  $result->execute();
                  $count = $result->rowCount();
                if ($count > 0) 
                { 
			 ...
			 echo"  <li style='background-image:none' ><a href='info-detail.php?inid=".$row['info_id']."'>".$row['title']."</a></li>";
              ...
              if(isset($_REQUEST["inid"]))
               {
                ...
                { 
                    ...
                    print"<h3 class='droid' align='right'><a href='info-detail.php?inid=".$row['info_id']."'>".$row['title']."</a></h3>";

                       print"<img src=../assets/img/info/".$row['photo']." />";
