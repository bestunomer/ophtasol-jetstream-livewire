              ...
              if(isset($_REQUEST["aid"]))
               {
                 ...
                 if(is_numeric($aid))
                 {
                      $result = $dbh->prepare("SELECT * from homepage_activities where language_id=3 and publish_id=1 and activities_id=:aid");
	   ...
	   <div class="span4 droid">
          <aside>
            ...
            <div class="widget droid">
              <h4 class="droid" align='right'>معلومات</h4>
...
<?php
                  ...
                  $result = $dbh->prepare("SELECT * from homepage_activities where language_id=3 and publish_id=1");
                  $result->execute();
                  $count = $result->rowCount();
                if ($count > 0) 
                { 
