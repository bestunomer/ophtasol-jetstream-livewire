...
<head>
  <meta charset="utf-8" />
  <title>الاخبار والنشاطات - ابن سینا</title>


  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="title" content="الاخبار والنشاطات - ابن سینا" />
...
<div class="span12">
      <div class=" headline"  style='direction:rtl'>
          <h2 class='droid' style="margin-bottom: 0;margin-right:5px;font-size:14px;" >اخر الاخبار والنشاطات</h2>
...
<?php
      ...
      where       
      language_id=3 and publish_id=1");
      $result->execute();
