...
<head>
  ...
  <title><?php
		  ...
		  $result = $dbh->prepare("SELECT * from about_us where language_id=3 and publish_id=1 and about_id=:about_id");
	    ...
	    <div class="span4 droid">
          <aside>
            ...
            <div class="widget droid">
              <h4 class="droid" align='right'>من نحن</h4>
...
<?php
                  ...
                  $result = $dbh->prepare("SELECT * from about_us where language_id=3 and publish_id=1");
                  $result->execute();
        ...
        <div class="span8">
		  ...
		  $row=$result->fetch(PDO::FETCH_ASSOC);  
            ...
            <button type='button' class='btn btn-default pull-right' onclick='zoomin();'>A-</button>
                       ...
                       print"<p class='droid zoom'>".$row['detail']."</p>";
                      if(!empty($row['video']))
					  {
