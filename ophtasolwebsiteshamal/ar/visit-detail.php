              ...
              if(isset($_REQUEST["vid"]))
               {
                 ...
                 if(is_numeric($vid))
                 {
                    $result = $dbh->prepare("SELECT * from your_visit where language_id=3 and publish_id=1 and visit_id=:vid");
      ...
      <div class="row">
          ...
          <aside>
            ...
            <div class="widget droid">
              <h4 class="droid" align='right'>زیارتك</h4>
...
<?php
                  ...
                  $result = $dbh->prepare("SELECT * from your_visit where language_id=3 and publish_id=1");
                  $result->execute();
                  $count = $result->rowCount();
                if ($count > 0) 
                { 
			 ...
			 echo"  <li style='background-image:none' ><a href='visit-detail.php?vid=".$row['visit_id']."'>".$row['title']."</a></li>";
              ...
              if(isset($_REQUEST["vid"]))
               {
                ...
                { 
                       ...
                       print"<h3 align='right' class='droid'><a href='visit-detail.php?vid=".$row['visit_id']."'>".$row['title']."</a></h3>";
                       print"<img src=../assets/img/visit/".$row['photo']." />";
