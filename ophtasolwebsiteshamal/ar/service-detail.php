              ...
              if(isset($_REQUEST["sid"]))
               {
                 ...
                 if(is_numeric($sid))
                 {
                    $result = $dbh->prepare("SELECT * from service where language_id=3 and publish_id=1 and service_id=:sid");
      ...
      <div class="row">
          ...
          <aside>
            ...
            <div class="widget droid">
              <h4 class="droid" align='right'>الخدمات</h4>
...
<?php
                  ...
                  $result = $dbh->prepare("SELECT * from service where language_id=3 and publish_id=1 limit 10");
                  $result->execute();
                  $count = $result->rowCount();
                if ($count > 0) 
                { 
			 ...
			 echo"  <li style='background-image:none' ><a href='service-detail.php?sid=".$row['service_id']."'>".$row['title']."</a></li>";
              ...
              if(isset($_REQUEST["sid"]))
               {
                ...
                $count = $result->rowCount();
                  ...
                  { 
                       ...
                       print"<h3 align='right' class='droid'><a href='service-detail.php?sid=".$row['service_id']."'>".$row['title']."</a></h3>";
                       print"<img src=../assets/img/services/".$row['photo']." />";
