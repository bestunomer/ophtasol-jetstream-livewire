...
function GetPageInfos()
{
    ...
    $result[] = array('caption' => 'Support Letter', 'short_caption' => 'Support Letter', 'filename' => 'support_letter.php', 'name' => 'support_letter', 'group_name' => 'Default', 'add_separator' => true, 'description' => '');
    $result[] = array('caption' => 'Necessary Forms', 'short_caption' => 'Necessary Forms', 'filename' => 'necessary_forms.php', 'name' => 'necessary_forms', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
