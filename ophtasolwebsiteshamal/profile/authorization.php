...
$dataSourceRecordPermissions = array('doctor' => new DataSourceRecordPermission('doctor_id', false, false, false, true, false, true),
  'support_letter' => new DataSourceRecordPermission('doctor_id', false, false, false, true, false, true));

$tableCaptions = array('doctor' => 'Doctor',
'support_letter' => 'Support Letter',
'necessary_forms' => 'Necessary Forms');
...
function CreateTableBasedGrantManager()
{
    ...
    $userPermsTableInfo = array('TableName' => 'doctor_user_perms', 'UserId' => 'user_id', 'PageName' => 'page_name', 'Grant' => 'perm_name');
