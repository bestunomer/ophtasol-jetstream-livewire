 ...
 */
    ...
    class support_letterPage extends Page
    {
        ...
        {
            $this->SetTitle('Support Letter English');
            $this->SetMenuLabel('Support Letter English');
            ...
            $this->dataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'support_letter.language_id=1'));
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_support_letter_doctor_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('doctor_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_support_letter_doctor_id_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_support_letter_language_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('language_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_support_letter_language_id_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Staff', 'doctor_id', 'doctor_id_fullname', 'edit_support_letter_doctor_id_search', $editor, $this->dataset, $lookupDataset, 'doctor_id', 'fullname', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Language', 'language_id', 'language_id_language', 'edit_support_letter_language_id_search', $editor, $this->dataset, $lookupDataset, 'language_id', 'language', '');
            $editColumn->SetReadOnly(true);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('fullname', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Staff', 'doctor_id', 'doctor_id_fullname', 'multi_edit_support_letter_doctor_id_search', $editor, $this->dataset, $lookupDataset, 'doctor_id', 'fullname', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('language', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Language', 'language_id', 'language_id_language', 'multi_edit_support_letter_language_id_search', $editor, $this->dataset, $lookupDataset, 'language_id', 'language', '');
            $editColumn->SetReadOnly(true);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('fullname', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Staff', 'doctor_id', 'doctor_id_fullname', 'insert_support_letter_doctor_id_search', $editor, $this->dataset, $lookupDataset, 'doctor_id', 'fullname', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('language', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Language', 'language_id', 'language_id_language', 'insert_support_letter_language_id_search', $editor, $this->dataset, $lookupDataset, 'language_id', 'language', '');
            $editColumn->SetReadOnly(true);
            $editColumn->SetAllowSetToNull(true);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('language', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_support_letter_language_id_search', 'language_id', 'language', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('fullname', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_support_letter_doctor_id_search', 'doctor_id', 'fullname', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('language', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_support_letter_language_id_search', 'language_id', 'language', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('language', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_support_letter_language_id_search', 'language_id', 'language', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('language', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_support_letter_language_id_search', 'language_id', 'language', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new support_letterPage("support_letter", "support_letter_en.php", GetCurrentUserPermissionSetForDataSource("support_letter"), 'UTF-8');
