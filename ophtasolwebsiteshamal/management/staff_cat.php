 ...
 */
    ...
    class doctor_catPage extends Page
    {
        ...
        {
            $this->SetTitle('Staff Category');
            $this->SetMenuLabel('Staff Category');
        ...
        {
            $columnFilter
                ->setOptionsFor('publish_id');
        }
    
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            $main_editor = new TextEdit('doctor_cat_edit');
            ...
            $main_editor = new TextEdit('doctor_cat_k_edit');
            $main_editor->SetMaxLength(50);
            
            $filterBuilder->addColumn(
                $columns['doctor_cat_K'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
            ...
            $main_editor = new TextEdit('doctor_cat_a_edit');
            $main_editor->SetMaxLength(50);
            
            $filterBuilder->addColumn(
                $columns['doctor_cat_A'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
            ...
            $main_editor = new DynamicCombobox('publish_id_edit', $this->CreateLinkBuilder());
            $main_editor->setAllowClear(true);
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_doctor_cat_publish_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('publish_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_doctor_cat_publish_id_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            $column->SetFullTextWindowHandlerName('doctor_catGrid_doctor_cat_handler_list');
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('doctor_catGrid_doctor_cat_handler_view');
        ...
        protected function AddPrintColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('doctor_catGrid_doctor_cat_handler_print');
        ...
        protected function AddExportColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('doctor_catGrid_doctor_cat_handler_export');
        ...
        private function AddCompareColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('doctor_catGrid_doctor_cat_handler_compare');
        ...
        protected function doRegisterHandlers() {
            ...
            $column = new TextViewColumn('doctor_cat', 'doctor_cat', 'Doctor Category', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'doctor_catGrid_doctor_cat_handler_list', $column);
            ...
            $column = new TextViewColumn('doctor_cat', 'doctor_cat', 'Doctor Category', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'doctor_catGrid_doctor_cat_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('doctor_cat', 'doctor_cat', 'Doctor Category', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'doctor_catGrid_doctor_cat_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('publish_title', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_doctor_cat_publish_id_search', 'publish_id', 'publish_title', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('doctor_cat', 'doctor_cat', 'Doctor Category', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'doctor_catGrid_doctor_cat_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
    ...
    try
    {
        $Page = new doctor_catPage("doctor_cat", "staff_cat.php", GetCurrentUserPermissionSetForDataSource("doctor_cat"), 'UTF-8');
