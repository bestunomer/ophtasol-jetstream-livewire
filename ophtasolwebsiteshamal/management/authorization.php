...
$tableCaptions = array('doctor' => 'All Staff',
'doctor.staff_contracts' => 'All Staff->Staff Contracts',
'doctor_cat' => 'Staff Category',
'employment_category' => 'Employment Category',
'necessary_forms' => 'Necessary Forms',
'support_letter' => 'Support Letter English',
'support_letter01' => 'Support Letter Kurdish-Arabic');
...
function CreateTableBasedGrantManager()
{
    ...
    $userPermsTableInfo = array('TableName' => 'user_permission_management', 'UserId' => 'user_id', 'PageName' => 'page_name', 'Grant' => 'perm_name');
