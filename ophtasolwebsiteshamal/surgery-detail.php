  ...
  <title><?php if(isset($_REQUEST["suid"]))
               {
                 ...
                 if(is_numeric($suid))
                 {
                    $result = $dbh->prepare("SELECT * from surgery where language_id=2 and publish_id=1 and surgery_id=:suid");
      ...
      <div class="row">
          ...
          <aside>
            ...
            <div class="widget droid">
              <h4 class="droid" align='right'>نەشتەرگەری</h4>
...
<?php
                  ...
                  $result = $dbh->prepare("SELECT * from surgery where language_id=2 and publish_id=1");
                  $result->execute();
                  $count = $result->rowCount();
                if ($count > 0) 
                { 
