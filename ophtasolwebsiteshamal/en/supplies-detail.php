...
<head>
              ...
              if(isset($_REQUEST["vid"]))
               {
                 ...
                 if(is_numeric($vid))
                 {
                    $result = $dbh->prepare("SELECT * from medical_supplies where language_id=1 and publish_id=1 and supplies_id=:vid");
  ...
  <meta name="author" content="Ophtaso Co. Ltd. Eye Health & Vision Care" />
              ...
              if(isset($_REQUEST["vid"]))
               {
                ...
                { 
                       ...
                       print"<h3 align='left'><a href='supplies-detail.php?vid=".$row['supplies_id']."'>".$row['title']."</a></h3>";
                       print"<a href='supplies-detail.php?vid=".$row['supplies_id']."'><img src=../assets/img/supplies/".$row['photo']." /></a>";
...
<?php
                  ...
                  $result = $dbh->prepare("SELECT * from medical_supplies where language_id=1 and publish_id=1 ");
                  $result->execute();
                  $count = $result->rowCount();
                if ($count > 0) 
                { 
			 ...
			 echo"  <li><a href='supplies-detail.php?vid=".$row['supplies_id']."'>".$row['title']."</a></li>";
