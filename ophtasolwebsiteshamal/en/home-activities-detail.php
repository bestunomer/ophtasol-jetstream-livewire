...
<head>
  <meta charset="utf-8" />
  <title>ibinsina - Modern eye & retina center</title>
              ...
              if(isset($_REQUEST["aid"]))
               {
                 ...
                 if(is_numeric($aid))
                 {
                      $result = $dbh->prepare("SELECT * from homepage_activities where language_id=1 and publish_id=1 and activities_id=:aid");
                ...
                $count = $result->rowCount();
				 $row=$result->fetch(PDO::FETCH_ASSOC);  
                  ...
                  { 
                      ...
                      print"<h3 align='left'><a href='home-activities-detail.php?aid=".$row['activities_id']."'>".$row['title']."</a></h3>";
                      print"<a href='home-activities-detail.php?aid=".$row['activities_id']."'><img src=../assets/img/activities/homepage/".$row['photo']." /></a>";
...
<?php
                  ...
                  $result = $dbh->prepare("SELECT * from homepage_activities where language_id=1 and publish_id=1");
                  $result->execute();
                  $count = $result->rowCount();
                if ($count > 0) 
                { 
			 ...
			 echo"  <li><a href='home-activities-detail.php?aid".$row['activities_id']."'>".$row['title']."</a></li>";
