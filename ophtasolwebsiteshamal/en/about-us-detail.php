...
<head>
  ...
  <title>Ibinsina Hospital - <?php
		  ...
		  $result = $dbh->prepare("SELECT * from about_us where language_id=1 and publish_id=1 and about_id=:about_id");
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner" style='border-bottom: 2px solid #3d5b9b;'>
        <div class="container">
			...
			<a href="#" id="scroll" style="display: hidden;"><span></span></a>
          ...
          <div class="well">
            <div class="centered">
              ...
              <?php
                       ...
                       print"<a href='about-us-detail.php?abid=".$row['about_id']."'><img src=../assets/img/".$row['photo']." /></a>";
...
<?php
                  ...
                  $result = $dbh->prepare("SELECT * from about_us where language_id=1 and publish_id=1");
                  $result->execute();
			 ...
			 echo"  <li><a href='about-us-detail.php?abid=".$row['about_id']."'>".$row['tab_title']."</a></li>";
...
<script src="../assets/js/script.js?v=201906021342480"></script>
