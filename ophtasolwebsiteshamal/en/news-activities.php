...
<head>
  <meta charset="utf-8" />
  <title>Ibinsina Hospital - News and Activities</title>


  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="title" content="Ibinsina Hospital - News and Activities" />
...
================================================== -->
  <section id="maincontent">
    <div class="jumbotron subhead" id="overview" style="padding-top: 0px">
      <div class="container" >
...
<?php
      ...
      where       
      language_id=1 and publish_id=1");
      $result->execute();
     ...
     print"<div class=span3>";
                    ...
                    print"<a href=news-detail.php?nid=".$row1['news_id']."><h5 class=title>".$row1['title']."</h5></a>";
				    print"<p style='margin-bottom: 2px;'>".$row1['publish_date']."</p>";

                    print"</a>";
                    print"<p>".$row1['short_detail']."</p>";
                    print"</div>";
